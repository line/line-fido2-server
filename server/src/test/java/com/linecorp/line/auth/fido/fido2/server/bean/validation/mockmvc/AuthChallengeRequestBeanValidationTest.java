...
class AuthChallengeRequestBeanValidationTest extends BeanValidationTestSupport {

    private MockMvc mockMvc;
    private static AuthOptionRequest origin;
    private AuthOptionRequest authChallengeRequest;
    ...
    void setUp(final WebApplicationContext context) throws IOException {
        ...
        //Deep copy
        authChallengeRequest = objectMapper.readValue(objectMapper.writeValueAsString(origin), AuthOptionRequest.class);
    }
