...
IMPORTANT: These are not within the scope of the WebAuthn specification but its own APIs.
...
IMPORTANT: This is not within the scope of the WebAuthn specification but its own API.
