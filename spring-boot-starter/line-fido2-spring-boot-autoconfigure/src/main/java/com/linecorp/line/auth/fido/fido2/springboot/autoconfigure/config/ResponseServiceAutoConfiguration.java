...
@Configuration
@ComponentScan(basePackages = "com.linecorp.line.auth.fido.fido2.server.attestation")
@EntityScan(basePackages = {"com.linecorp.line.auth.fido.fido2.server.entity"})
@ConditionalOnClass(ResponseService.class)
public class ResponseServiceAutoConfiguration {

    @Bean
    @ConditionalOnMissingBean
    public ResponseService responseService(SessionService sessionService,
